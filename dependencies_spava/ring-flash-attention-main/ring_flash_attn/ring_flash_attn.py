...
def ring_flash_attn_forward(
    ...
    for step in range(comm.world_size):
        ...
        if not causal or step <= comm.rank:
            ...
            # dist.barrier()
            # if (out.isnan().any() or lse.isnan().any()):
            #     breakpoint()
            # dist.barrier()
    ...
    if breakdown:
        return (out, (every_end - every_beg) - attn_t, attn_t), lse # comm here is the time that cannot be overlaped with attn calc
    return out, lse
