...
# python $SCRIPT -p $MODEL_PATH -n $MODEL_NAME -a lring -pc $PROMPT_CONFIG -l 131072 -np 8 --time --breakdown
...
# python $SCRIPT -p $MODEL_PATH -n $MODEL_NAME -a minf -pc $PROMPT_CONFIG -l 131072 --time --breakdown
