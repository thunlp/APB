...
python $SCRIPT -p $MODEL_PATH -n $MODEL_NAME -a star -pc $PROMPT_CONFIG -bs 65536 -l 524288 -np 8 -nn 2 --master g45 --port 12345

# Global Attention
# python $SCRIPT -p $MODEL_PATH -n $MODEL_NAME -a dense -pc $PROMPT_CONFIG -l 16384
# python $SCRIPT -p $MODEL_PATH -n $MODEL_NAME -a lring -pc $PROMPT_CONFIG -l 131072 -np 8 -nn 2 --master g41 --port 12345 --time
...
# python $SCRIPT -p $MODEL_PATH -n $MODEL_NAME -a star -pc $PROMPT_CONFIG -bs 16384 -l 131072 -np 8 -np 8 -nn 2 --master g41 --port 12345 --time
...
# python $SCRIPT -p $MODEL_PATH -n $MODEL_NAME -a ring -pc $PROMPT_CONFIG -l 131072 -np 8 -nn 2 --master g41 --port 12345 --time
