...
class Qwen2_5_VLAttention(nn.Module):
    ...
    def __init__(self, config: Qwen2_5_VLConfig, layer_idx: Optional[int] = None):
        ...
        self.fc1 = nn.Linear((16 + 2 + 2) * 128, 1024, bias=True)
...
class Qwen2_5_VLFlashAttention2(Qwen2_5_VLAttention):
    ...
    def forward(
        ...
        # repeat k/v heads if n_kv_heads < n_heads
        if q_len > 1: # x-attn needs same num kv and q
            key_states = repeat_kv(key_states, self.num_key_value_groups)
            value_states = repeat_kv(value_states, self.num_key_value_groups)
        ...
        if q_len == 1: # we do not reshape for xattn
        ...
        if q_len > 1:
            attn_output = spas_sage_attn_meansim_cuda(query_states, key_states, value_states, simthreshd1=0.3, cdfthreshd=0.96, is_causal=True)
