...
class VideoInferencePipeline:
    def __init__(self, model_path, dataset_path, json_file, rank, world_size):
        ...
        self.model = Qwen2_5_VLForConditionalGeneration.from_pretrained(
            model_path,
            # "/your_path_prefix/apb-v/checkpoints_nextqa_qembed_ltr_7B/checkpoint_8000",
            # "/your_path_prefix/apb-v/checkpoints_nextqa_qembed_listmle/checkpoint_6000",
            # "/data3/apb-v-checkpoint-3000",
    ...
    def process_single_sample(self, data):
        ...
        # messages[0]['content'] = messages[0]['content'][-1:] + messages[0]['content']
