    ...
    def run_evaluation(self, frame_num=-1):
        ...
        for _ in range(5):
            response = self.model.chat(self.tokenizer, pixel_values, question, generation_config,
                                num_patches_list=num_patches_list, history=None, return_history=False, bare_question=qs)
...
def main(rank, world_size):
    ...
    if dist.get_rank() == 0:
        ...
        fp = open(f"{model_name}/apbv_{clarity}p_{min_frame_num}_{max_frame_num}.jsonl", "w")
