...
from qwen2_5_vl.modeling_qwen2_5_vl_x import Qwen2_5_VLForConditionalGeneration
...
def main(rank, world_size):
    ...
    fp = open(f"{model_name}/xattn_{clarity}p_{min_frame_num}_{max_frame_num}.jsonl", "w")
