...
from qwen2_5_vl.modeling_qwen2_5_vl_zzring import Qwen2_5_VLForConditionalGeneration
...
class VideoInferencePipeline:
    ...
    def process_single_sample(self, data):
        ...
        try:
            generated_ids = self.model.zzring_generate(
...
def main(rank, world_size):
    ...
    if dist.get_rank() == 0:
        ...
        fp = open(f"{model_name}/zzring_{clarity}p_{min_frame_num}_{max_frame_num}.jsonl", "w")
