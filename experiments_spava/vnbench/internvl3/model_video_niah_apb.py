...
def run_inference(args, rank, world_size):
    ...
    model = InternVLChatModel.from_pretrained(
        # pretrained,
        "/your_path_prefix/apb-v/checkpoints_apb_baseline_2b/checkpoint_3000",
    ...
    qa_dataloader = DataLoader(qa_dataset, batch_size=None, shuffle=False, num_workers=16, prefetch_factor=4)
    ...
    for q_dict in tqdm(qa_dataloader):
        ...
        response = model.chat(tokenizer, pixel_values, qs, generation_config,
                               num_patches_list=num_patches_list, history=None, return_history=False, bare_question=bare_question)
