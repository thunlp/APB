...
from internvl3.modeling_internvl_chat_sparge import InternVLChatModel
...
def run_inference(args):
    ...
    qa_dataloader = DataLoader(qa_dataset, batch_size=None, shuffle=False, num_workers=8, prefetch_factor=1)
