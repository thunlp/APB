...
for IDX in $(seq 0 $((CHUNKS-1))); do
    ...
    CUDA_VISIBLE_DEVICES=$GPU_ID python qwenvl2_5/model_video_niah_sparge.py \
    --model-path $CKPT \
    --video_dir $VIDEODIR \
