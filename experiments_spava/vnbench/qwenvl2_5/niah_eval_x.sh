...
#     # CUDA_VISIBLE_DEVICES=$GPU_ID python qwenvl2_5/model_video_niah_x.py \
#     CUDA_VISIBLE_DEVICES=6,7 python qwenvl2_5/model_video_niah_x.py \
#     --model-path $CKPT \
#     --video_dir $VIDEODIR \
...
python ./qwenvl2_5/evaluation_utils.py --result_path $output_file