...
class Qwen2_5_VLModel(Qwen2_5_VLPreTrainedModel):
    ...
    def forward(
        ...
        if cache_position is None:
            past_seen_tokens = past_key_values.get_seq_length() if past_key_values is not None and isinstance(past_key_values, Cache) else 0
            past_seen_tokens = past_key_values[0][0].shape[2] if isinstance(past_key_values, tuple) else 0
        ...
        for i, decoder_layer in enumerate(self.layers):
            ...
            if self.gradient_checkpointing and self.training:
                layer_outputs = self._gradient_checkpointing_func(
                    ...
                    causal_mask,
                    position_ids,
                    past_key_values if isinstance(past_key_values, Cache) else past_key_values[i],
                    output_attentions,
                    use_cache,
                    cache_position,
                    position_embeddings,
                ...
                layer_outputs = decoder_layer(
                    ...
                    position_ids=position_ids,
                    past_key_value=past_key_values if isinstance(past_key_values, Cache) else past_key_values[i],
                    output_attentions=output_attentions,
                    use_cache=use_cache,
                    cache_position=cache_position,
                    position_embeddings=position_embeddings,
    ...
    def forward(
        ...
        if position_ids is None and (attention_mask is None or attention_mask.ndim == 2):
            ...
            if (
                ...
                or (past_key_values is None or (isinstance(past_key_values, Cache) and past_key_values.get_seq_length() == 0))
            ):
